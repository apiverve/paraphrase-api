// Package paraphrase provides a Go client for the Paraphrase API.
//
// For more information, visit: https://apiverve.com/marketplace/paraphrase?utm_source=go&utm_medium=readme
package paraphrase
...
// Request contains the parameters for the Paraphrase API.
//
// Parameters:
//   - text (required): string - The text to paraphrase [maxLength: 5000]
//   - style: string - Paraphrase style: formal, casual, simple, or creative
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"text": {Type: "string", Required: true, MaxLength: intPtr(5000)},
...
// ResponseData contains the data returned by the Paraphrase API.
type ResponseData struct {
	Original string `json:"original"`
	Paraphrased string `json:"paraphrased"`
	Style string `json:"style"`
	OriginalWords int `json:"originalWords"`
	ParaphrasedWords int `json:"paraphrasedWords"`
}
