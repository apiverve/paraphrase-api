...
namespace APIVerve.API.Paraphrase
{
    ...
    /// <summary>
    /// Client for the Paraphrase API
    /// </summary>
    public class ParaphraseAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/paraphrase";
        ...
        {
            { "text", new ValidationRule { Type = "string", Required = true, MaxLength = 5000 } },
        ...
        public ParaphraseAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ParaphraseAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ParaphraseAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ParaphraseQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ParaphraseQueryOptions options)
        {
        ...
        public ResponseObj Execute(ParaphraseQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ParaphraseQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ParaphraseQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ParaphraseQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ParaphraseQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ParaphraseQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ParaphraseQueryOptions options)
        {
