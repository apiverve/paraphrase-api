...
class paraphraseWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/paraphrase');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true,"maxLength":5000},"style":{"type":"string","required":false,"default":"formal"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/paraphrase`);
        }
    }
...
module.exports = paraphraseWrapper;
