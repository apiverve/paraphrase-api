/*
 * Paraphrase API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Paraphrase API.
 * API Documentation: https://docs.apiverve.com/ref/paraphrase
 */
...
namespace APIVerve.Examples
{
    class ParaphraseExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/paraphrase";

        /// <summary>
        /// Make a GET request to the Paraphrase API
        /// </summary>
        static async Task<JsonDocument> CallParaphraseAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling Paraphrase API...\n");

            var result = await CallParaphraseAPI();
