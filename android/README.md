...
```gradle
dependencies {
    implementation 'com.github.apiverve:paraphrase-api:1.1.14'
}
```
...
```java
import com.apiverve.paraphrase.ParaphraseAPIClient;
import com.apiverve.paraphrase.APIResponse;
import com.apiverve.paraphrase.APIException;

// Initialize the client
ParaphraseAPIClient client = new ParaphraseAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("text", "The quick brown fox jumps over the lazy dog.");
    parameters.put("style", "formal");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/paraphrase](https://docs.apiverve.com/ref/paraphrase)
...
- **Documentation:** [https://docs.apiverve.com/ref/paraphrase](https://docs.apiverve.com/ref/paraphrase)
- **Issues:** [GitHub Issues](https://github.com/apiverve/paraphrase-api/issues)
